...
static GLfloat vdata[12][3] = {
  {-X*2, 0.0, X*3}, {X*2, 0.0, X*3}, {-X*2, 0.0, -X*3}, {X*2, 0.0, -X*3},
  {0.0, X, X*3}, {0.0, X, -X*3}, {0.0, -X, X*3}, {0.0, -X, -X*3},
  {X*2, X, 0.0}, {-X*2, X, 0.0}, {X*2, -X, 0.0}, {-X*2, -X, 0.0}
};
...
int rotatex = 0; 
int rotatey = 0; // for rotate by axis x,y,z
int solid=0;
...
{
  GLfloat d = sqrt(2*X*X/(v[0]*v[0]/A + v[1]*v[1]/B + v[2]*v[2]/C));
  /* omit explict check for division by zero */
